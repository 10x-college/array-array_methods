აქ არის 10 ახალი პრაქტიკული დავალება, სადაც **მხოლოდ რიცხვების და სტრინგების მასივებია** გამოყენებული (ობიექტების გარეშე). თითოეული დავალება ეხება კონკრეტულ მეთოდს ან მათ კომბინაციას.

ეს დავალებები დაეხმარება სტუდენტებს ლოგიკური აზროვნების განვითარებაში.
